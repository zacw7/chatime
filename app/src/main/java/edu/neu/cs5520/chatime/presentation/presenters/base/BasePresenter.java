package edu.neu.cs5520.chatime.presentation.presenters.base;
...
public interface BasePresenter {
    ...
    /**
     * Method that controls the lifecycle of the view. It should be called in the view's (Activity
     * or Fragment) onPause() method.
     */
    void pause();

    /**
     * Method that controls the lifecycle of the view. It should be called in the view's (Activity
     * or Fragment) onStop() method.
     */
    void stop();
